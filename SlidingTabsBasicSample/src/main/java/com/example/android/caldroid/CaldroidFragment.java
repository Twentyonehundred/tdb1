package com.example.android.caldroid;
...
import com.example.android.infiniteviewpager.InfinitePagerAdapter;
import com.example.android.infiniteviewpager.InfiniteViewPager;
...
public class CaldroidFragment extends DialogFragment {
    ...
    private ArrayList<com.example.android.caldroid.DateGridFragment> fragments;
     ...
     */
    protected ArrayList<com.example.android.caldroid.CaldroidGridAdapter> datePagerAdapters = new ArrayList<com.example.android.caldroid.CaldroidGridAdapter>();
     ...
     * Caldroid
     */
    private com.example.android.caldroid.CaldroidListener caldroidListener;

    public com.example.android.caldroid.CaldroidListener getCaldroidListener() {
     ...
     */
    public com.example.android.caldroid.CaldroidGridAdapter getNewDatesGridAdapter(int month, int year) {
        return new com.example.android.caldroid.CaldroidGridAdapter(getActivity(), month, year,
     ...
     */
    public ArrayList<com.example.android.caldroid.DateGridFragment> getFragments() {
        return fragments;
    }
     ...
     * @return
     */
    public ArrayList<com.example.android.caldroid.CaldroidGridAdapter> getDatePagerAdapters() {
    ...
    public void setBackgroundResourceForDates(
        ...
        for (Date date : backgroundForDateMap.keySet()) {
            ...
            DateTime dateTime = com.example.android.caldroid.CalendarHelper.convertDateToDateTime(date);
    ...
    public Bundle getSavedStates() {
        ...
        if (selectedDates != null && selectedDates.size() > 0) {
            bundle.putStringArrayList(SELECTED_DATES,
                    com.example.android.caldroid.CalendarHelper.convertToStringList(selectedDates));
        }

        if (disableDates != null && disableDates.size() > 0) {
            bundle.putStringArrayList(DISABLE_DATES,
                    com.example.android.caldroid.CalendarHelper.convertToStringList(disableDates));
        }
    ...
    public void moveToDate(Date date) {
        moveToDateTime(com.example.android.caldroid.CalendarHelper.convertDateToDateTime(date));
    }
    ...
    public void setCalendarDate(Date date) {
        setCalendarDateTime(com.example.android.caldroid.CalendarHelper.convertDateToDateTime(date));
    }
    ...
    public void setDisableDatesFromString(ArrayList<String> disableDateStrings,
        ...
        for (String dateString : disableDateStrings) {
            DateTime dateTime = com.example.android.caldroid.CalendarHelper.getDateTimeFromString(
    ...
    public void setSelectedDates(Date fromDate, Date toDate) {
        ...
        DateTime fromDateTime = com.example.android.caldroid.CalendarHelper.convertDateToDateTime(fromDate);
        DateTime toDateTime = com.example.android.caldroid.CalendarHelper.convertDateToDateTime(toDate);
    ...
    public void setSelectedDateStrings(String fromDateString,
        ...
        Date fromDate = com.example.android.caldroid.CalendarHelper.getDateFromString(fromDateString,
                dateFormat);
        Date toDate = com.example.android.caldroid.CalendarHelper
    ...
    public void setMinDate(Date minDate) {
        if (minDate == null) {
            ...
            minDateTime = com.example.android.caldroid.CalendarHelper.convertDateToDateTime(minDate);
        }
    }
    ...
    public void setMinDateFromString(String minDateString, String dateFormat) {
        if (minDateString == null) {
            ...
            minDateTime = com.example.android.caldroid.CalendarHelper.getDateTimeFromString(minDateString,
                    dateFormat);
        }
    }
    ...
    public void setMaxDate(Date maxDate) {
        if (maxDate == null) {
            ...
            maxDateTime = com.example.android.caldroid.CalendarHelper.convertDateToDateTime(maxDate);
        }
    }
    ...
    public void setMaxDateFromString(String maxDateString, String dateFormat) {
        if (maxDateString == null) {
            ...
            maxDateTime = com.example.android.caldroid.CalendarHelper.getDateTimeFromString(maxDateString,
                    dateFormat);
        }
    }
     ...
     */
    public void setCaldroidListener(com.example.android.caldroid.CaldroidListener caldroidListener) {
            ...
            dateItemClickListener = new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    if (caldroidListener != null) {
                        ...
                        Date date = com.example.android.caldroid.CalendarHelper
    ...
    public void refreshView() {
        ...
        for (com.example.android.caldroid.CaldroidGridAdapter adapter : datePagerAdapters) {
            // Reset caldroid data
    ...
    protected void retrieveInitialArgs() {
        ...
        if (args != null) {
            ...
            if (disableDateStrings != null && disableDateStrings.size() > 0) {
                disableDates.clear();
                for (String dateString : disableDateStrings) {
                    DateTime dt = com.example.android.caldroid.CalendarHelper.getDateTimeFromString(
            ...
            if (minDateTimeString != null) {
                minDateTime = com.example.android.caldroid.CalendarHelper.getDateTimeFromString(
                        minDateTimeString, null);
            }

            String maxDateTimeString = args.getString(MAX_DATE);
            if (maxDateTimeString != null) {
                maxDateTime = com.example.android.caldroid.CalendarHelper.getDateTimeFromString(
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        com.example.android.caldroid.WeekdayArrayAdapter weekdaysAdapter = new com.example.android.caldroid.WeekdayArrayAdapter(
    ...
    private void setupDateGridPages(View view) {
        ...
        // Current month
        com.example.android.caldroid.CaldroidGridAdapter adapter0 = getNewDatesGridAdapter(
        ...
        DateTime nextDateTime = currentDateTime.plus(0, 1, 0, 0, 0, 0, 0,
                DateTime.DayOverflow.LastDay);
        com.example.android.caldroid.CaldroidGridAdapter adapter1 = getNewDatesGridAdapter(
                nextDateTime.getMonth(), nextDateTime.getYear());

        // Next 2 month
        DateTime next2DateTime = nextDateTime.plus(0, 1, 0, 0, 0, 0, 0,
                DateTime.DayOverflow.LastDay);
        com.example.android.caldroid.CaldroidGridAdapter adapter2 = getNewDatesGridAdapter(
                next2DateTime.getMonth(), next2DateTime.getYear());

        // Previous month
        DateTime prevDateTime = currentDateTime.minus(0, 1, 0, 0, 0, 0, 0,
                DateTime.DayOverflow.LastDay);
        com.example.android.caldroid.CaldroidGridAdapter adapter3 = getNewDatesGridAdapter(
        ...
        // MonthPagerAdapter
        final com.example.android.caldroid.MonthPagerAdapter pagerAdapter = new com.example.android.caldroid.MonthPagerAdapter(
        ...
        for (int i = 0; i < NUMBER_OF_PAGES; i++) {
            com.example.android.caldroid.DateGridFragment dateGridFragment = fragments.get(i);
            com.example.android.caldroid.CaldroidGridAdapter adapter = datePagerAdapters.get(i);
    ...
    private ArrayList<String> getDaysOfWeek() {
        ...
        for (int i = 0; i < 7; i++) {
            Date date = com.example.android.caldroid.CalendarHelper.convertDateTimeToDate(nextDay);
    ...
    public class DatePageChangeListener implements OnPageChangeListener {
        ...
        private ArrayList<com.example.android.caldroid.CaldroidGridAdapter> caldroidGridAdapters;
         ...
         * @return
         */
        public ArrayList<com.example.android.caldroid.CaldroidGridAdapter> getCaldroidGridAdapters() {
            return caldroidGridAdapters;
        }

        public void setCaldroidGridAdapters(
                ArrayList<com.example.android.caldroid.CaldroidGridAdapter> caldroidGridAdapters) {
        ...
        public void refreshAdapters(int position) {
            ...
            com.example.android.caldroid.CaldroidGridAdapter currentAdapter = caldroidGridAdapters
                    .get(getCurrent(position));
            com.example.android.caldroid.CaldroidGridAdapter prevAdapter = caldroidGridAdapters
                    .get(getPrevious(position));
            com.example.android.caldroid.CaldroidGridAdapter nextAdapter = caldroidGridAdapters
